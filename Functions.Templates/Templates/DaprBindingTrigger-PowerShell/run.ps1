...
Write-Host "PowerShell DaprBinding trigger with DaprPublish output binding function processed a request."

$currentTime = Get-Date

$publishOutputBindingReqBody = @{
    "payload" = "Invoked by Dapr cron binding trigger: Hello, World! The time is $currentTime"
}
