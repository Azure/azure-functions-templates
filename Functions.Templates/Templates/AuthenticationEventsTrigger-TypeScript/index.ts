...
import { AuthenticationEventResponse, createFailedRequest, createProvideClaimsForToken, TokenIssuanceStartRequest } from "@azure/functions-authentication-events";
