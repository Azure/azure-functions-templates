...
@app.assistant_post_input(arg_name="state", id="{assistantId}", user_message="{message}", model="$(CHAT_MODEL_NAME)", chat_storage_connection_setting=DEFAULT_CHAT_STORAGE_SETTING, collection_name=DEFAULT_CHAT_COLLECTION_NAME)
