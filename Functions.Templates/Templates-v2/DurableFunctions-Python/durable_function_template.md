...
Following is an example code snippet for a basic Durable Funtions app using the [Python programming model V2](https://aka.ms/pythonprogrammingmodel) (currently in Preview).
...
- The function application is defined and named `myApp`.
